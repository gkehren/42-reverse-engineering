...
Buffer overflow sur `strcpy` nous devons donc trouver l’offset, pour ca on utilise [https://wiremask.eu/tools/buffer-overflow-pattern-generator/](https://wiremask.eu/tools/buffer-overflow-pattern-generator/)
